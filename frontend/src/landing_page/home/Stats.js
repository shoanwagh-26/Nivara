            ...
            <div className='row  p-5'>
                <div className='col-6  p-5'>
                    ...
                    <p className='text-muted'>
                        That's why 1.3+ crore customers trust with ₹3.5+ lakh crore worth
                    ...
                    <h2 className='fs-4'>The Nivara Universe</h2>
                    <p className='text-muted'>
                    ...
                    <p className='text-muted'>
                        With iniatiatives like Nudge and kill Switch, we don't just facilitate 
